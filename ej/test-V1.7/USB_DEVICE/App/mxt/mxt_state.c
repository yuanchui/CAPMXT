...
volatile uint8_t g_spi_check_requested = 1U;
volatile uint8_t g_spi_stream_enabled = 0;
volatile uint8_t g_spi_stream_mode = 0;
uint8_t g_spi_in_frame = 0;
uint16_t g_spi_frame_bytes = 0;
...
uint8_t g_spi_it_rx_buf[SPI_IT_CHUNK_LEN];
uint8_t g_spi_rx_queue[SPI_RX_QUEUE_DEPTH][SPI_IT_CHUNK_LEN];
uint8_t g_spi_nss_queue[SPI_RX_QUEUE_DEPTH];
volatile uint32_t g_spi_last_overflow_report_ms = 0;
uint8_t g_spi_nss_prev = 1U;
char g_spi_hex_tx_buf[SPI_HEX_TX_BUF_SIZE];
uint16_t g_spi_hex_tx_len = 0U;
volatile uint32_t g_spi_tx_drop = 0U;
uint8_t g_spi_start1_nss_page = 0U;
uint8_t g_spi_start1_collecting = 0U;
uint16_t g_spi_start1_payload_bytes = 0U;
uint8_t g_spi_start1_row_bytes = 0U;
uint8_t g_spi_start1_src_row_bytes = 0U;
uint8_t g_spi_start3_frame_id = 0U;
uint8_t g_spi_start3_row_id = 0U;
uint8_t g_spi_start3_row_buf[32];
uint8_t g_spi_start3_row_len = 0U;
